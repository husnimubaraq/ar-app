        ...
        <div className="">
            <div className="relative border-2 border-neutral-400 h-[70vh] mt-10">
                ...
                <div className="flex flex-col mt-[20%] items-center justify-center px-5">
                    ...
                    <p className="text-center mt-8">Pada saat menggunakan aplikasi ini, harap waspada terhadap lingkungan sekitar dan bahaya fisik Anda. Disarankan agar anak kecil mendapat pengawasan orang dewasa saat menggunakan Augmented Reality</p>
                </div>
